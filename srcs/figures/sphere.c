...
int		get_sphere_light(t_closest *closest, t_scene *scene, t_vec *dir, t_colb *colb)
{
    ...
    colb->surf_norm->u = colb->surf_norm->n < 0 ? colb->surf_norm->u * (-1) : colb->surf_norm->u;
    colb->surf_norm->v = colb->surf_norm->n < 0 ? colb->surf_norm->v * (-1) : colb->surf_norm->v;
    colb->surf_norm->n = colb->surf_norm->n < 0 ? colb->surf_norm->n * (-1) : colb->surf_norm->n;
    while (tmp)
    {
